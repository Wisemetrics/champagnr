...
ChampaignR is a highly productive, lightweight, and easy-to-use framework for R developers.
...
From the root of your project, install required packages by running:
  R -f script/install.R

And then launch your console:
...
Configure your redis server like this:
  TODO
